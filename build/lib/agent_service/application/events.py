...
class EventPublisher:
    def __init__(self, store: SQLiteStore, on_emit: Callable[[TaskEvent], None] | None = None):
        self.store = store
        self.on_emit = on_emit

    def _emit(self, task_id: str, event_type: EventType | str, payload: dict[str, Any]) -> TaskEvent:
        event = self.store.add_event(task_id, event_type, payload)
